...
export default function RecipeFinder() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <a href="https://github.com/koskogo/RecipeFinder" target="_blank" rel="noopener noreferrer" className="inline-block mb-4 px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors duration-200">Zum GitHub-Repository</a>
